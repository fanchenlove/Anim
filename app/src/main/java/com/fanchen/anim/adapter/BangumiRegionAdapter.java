 ...
 */
public class BangumiRegionAdapter extends BaseRecyclerAdapter<BangumiRegionAdapter.RegionViewHolder, AnimClass> {

    public BangumiRegionAdapter(Context context) {
        super(context);
    }
    ...
    public int getLayout() {
        return R.layout.item_bangumi_region;
    }
