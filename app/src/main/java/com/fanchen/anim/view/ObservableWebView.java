...
import com.fanchen.anim.view.call.Scrollable;
...
public class ObservableWebView extends WebView implements Scrollable {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mPrevScrollY < t) {
            mScrollState = ObservableScrollViewCallbacks.ScrollState.UP;
        } else if (t < mPrevScrollY) {
            mScrollState = ObservableScrollViewCallbacks.ScrollState.DOWN;
        } else {
            mScrollState = ObservableScrollViewCallbacks.ScrollState.STOP;
        }
        mPrevScrollY = t;
    }
