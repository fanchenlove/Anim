...
import com.fanchen.anim.adapter.pager.LoopPagerAdapterWrapper;
import com.fanchen.anim.animate.DepthPageTransformer;
import com.fanchen.anim.animate.ZoomOutPageTransformer;
import com.fanchen.anim.entity.inter.IBanner;
import com.fanchen.anim.entity.IndicatorLocation;
import com.fanchen.anim.entity.LoopStyle;
import com.fanchen.anim.util.L;
import com.fanchen.anim.util.Tools;
...
public class LoopViewPagerLayout extends RelativeLayout {
    ...
    private int size = Tools.dip2px(getContext(), 6);//The size of the set point;
...
//            LoopScroller mScroller = new LoopScroller(context, new CycleInterpolator(20));
     ...
     */
    public void setLoopData(ArrayList<? extends IBanner> bannerInfos) {
...
//                L.e("path " + path + " = length * " + length + " totalDistance " + totalDistance);
    ...
    public static abstract class OnDefaultImageViewLoader implements LoopViewPagerLayout.OnLoadImageViewListener {
