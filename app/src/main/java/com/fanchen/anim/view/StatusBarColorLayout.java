...
/**
 * Description: User: ZhengXingtian(lan4627@Gmail.com) Date: 2015-03-31 Time:
 * 23:55 Version: 1.0
 */
public class StatusBarColorLayout extends RelativeLayout {
	...
	public StatusBarColorLayout(Context context, AttributeSet attrs) {
		...
		TypedArray mTypedArray = context.obtainStyledAttributes(attrs,
				R.styleable.StatusBarColorLayout);
		barColor = mTypedArray.getColor(
				R.styleable.StatusBarColorLayout_barColor, 0);
		mTypedArray.recycle();
