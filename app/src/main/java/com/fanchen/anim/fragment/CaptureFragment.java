...
import com.fanchen.anim.camere.CameraManager;
import com.fanchen.anim.camere.decoding.CaptureActivityHandler;
import com.fanchen.anim.camere.decoding.InactivityTimer;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = null;
        if (bundle != null) {
            int layoutId = bundle.getInt(CodeUtils.LAYOUT_ID,-1);
            if (layoutId != -1) {
