...
public class LoopPagerAdapterWrapper extends PagerAdapter {
    ...
    public LoopPagerAdapterWrapper(Context context, ArrayList<? extends IBanner> bannerInfos, OnBannerItemClickListener onBannerItemClickListener, OnLoadImageViewListener onLoadImageViewListener) {
